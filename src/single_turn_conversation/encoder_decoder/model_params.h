...
#endif
{
    ...
    LookupTable<Param> keyword_extra_table;
    UniParams hidden_to_wordvector_params;
    UniParams hidden_to_keyword_params;
    UniParams hidden_to_keyword_extra_params;
    ...
    hidden_to_keyword_extra_params("hidden_to_keyword_extra_params"),
    left_to_right_encoder_params("lstm"), attention_params("attention"),
    keyword_attention_params("keyword_attention_params"){}

    Json::Value toJson() const override {
        Json::Value json;
        json["lookup_table"] = lookup_table.toJson();
        json["keyword_extra_table"] = keyword_extra_table.toJson();
        ...
        json["hidden_to_keyword_extra_params"] = hidden_to_keyword_extra_params.toJson();
    ...
    void fromJson(const Json::Value &json) override {
        ...
        keyword_extra_table.fromJson(json["keyword_extra_table"]);
        ...
        hidden_to_keyword_extra_params.fromJson(json["hidden_to_keyword_extra_params"]);
    ...
    std::vector<n3ldg_cuda::Transferable *> transferablePtrs() override {
        return {&lookup_table, &keyword_extra_table, &hidden_to_wordvector_params,
            &hidden_to_keyword_params, &hidden_to_keyword_extra_params,
            &left_to_right_encoder_params, &attention_params, &keyword_attention_params};
    }
#endif
