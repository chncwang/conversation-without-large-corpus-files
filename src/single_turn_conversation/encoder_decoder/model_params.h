...
#endif
{
    ...
    UniParams encoder_to_keyword_hidden_params;
    ...
    encoder_to_keyword_hidden_params("encoder_to_keyword_hidden_params") {}
    ...
    Json::Value toJson() const override {
        ...
        json["encoder_to_keyword_hidden_params"] = encoder_to_keyword_hidden_params.toJson();
        return json;
    }
    ...
    void fromJson(const Json::Value &json) override {
        ...
        encoder_to_keyword_hidden_params.fromJson(json["encoder_to_keyword_hidden_params"]);
    }
    ...
    std::vector<n3ldg_cuda::Transferable *> transferablePtrs() override {
        return {&lookup_table, &hidden_to_wordvector_params, &hidden_to_keyword_params,
            ...
            &encoder_to_keyword_hidden_params};
    }
#endif
