...
#endif
{
    ...
    UniParams hidden_to_all_word_params;
    ...
    attention_params("attention"), hidden_to_all_word_params("hidden_to_all_word_params") {}
    ...
    Json::Value toJson() const override {
        ...
        json["hidden_to_all_word_params"] = hidden_to_all_word_params.toJson();
        return json;
    }
    ...
    void fromJson(const Json::Value &json) override {
        ...
        hidden_to_all_word_params.fromJson(json["hidden_to_all_word_params"]);
    }

#if USE_GPU
    std::vector<n3ldg_cuda::Transferable *> transferablePtrs() override {
        return {&lookup_table, &hidden_to_wordvector_params, &hidden_to_keyword_params,
            &left_to_right_encoder_params, &attention_params, &hidden_to_all_word_params};
    }
#endif
